...
Identico nos tres. Java faz swap com variavel temporaria, C++ usa `swap`, Python troca com atribuicao multipla. A condicao `i % 5 == 2 || i % 5 == 3` eh a mesma. Em C, scanf le X e Y (uma por linha) e imprimo os do intervalo com resto 2 ou 3.
