...
Mesma base do 1117 com `Locale.US` no Java. O controle do menu usa do/while em Java e C++, e while com checagem em Python. A pergunta eh reimpressa enquanto a opcao nao for 1 nem 2.
