...
Java e C++ usam do/while (sempre le ao menos um grenal). Python usa loop infinito com break quando a opcao nao eh 1. As mensagens de saida seguem exatamente o formato do enunciado.
