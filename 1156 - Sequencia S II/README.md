...
Atencao a divisao em ponto flutuante: o denominador eh mantido como double para nao truncar. Java usa `Locale.US` no printf, C++ usa `printf("%.2f")`, Python usa f-string com `:.2f`. Em C, numerador impar e denominador dobrando, printf com %.2f.
