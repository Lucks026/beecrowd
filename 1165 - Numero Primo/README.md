...
Identico nos tres. O laco vai enquanto `i * i <= x` e para assim que acha um divisor. Java e C++ usam `long`/`long long`, Python usa while com inteiros nativos. Em C, teste de primalidade ate a raiz de X com long long.
