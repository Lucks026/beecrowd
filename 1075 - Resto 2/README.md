...
Identico nos tres. Um unico loop com verificacao de modulo. Python usa `range(1, 10001)`, Java e C++ usam `for(int i = 1; i <= 10000; i++)`. Em C, laco ate 10000 verificando o resto e printf.
