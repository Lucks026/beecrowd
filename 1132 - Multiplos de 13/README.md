...
Identico nos tres. Java faz swap com variavel temporaria, C++ usa `swap`, Python troca com atribuicao multipla. A verificacao `i % 13 != 0` eh a mesma. Python le os dois valores de `sys.stdin` para aceitar entrada em uma ou duas linhas.
