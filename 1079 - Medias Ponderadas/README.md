...
Java usa `Scanner.useLocale(Locale.US)` para leitura e `System.out.printf(Locale.US, "%.1f")` para saida decimal com ponto. C++ usa `printf("%.1f")`. Python usa f-string com `:.1f`. Todos formatam com 1 casa decimal. Em C, scanf le os tres valores por caso e printf com %.1f.
