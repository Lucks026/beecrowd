...
Identico nos tres. Loop com incremento de 2. Java usa concatenacao de String, C++ usa `cout` encadeado, Python usa f-string. Mesmo formato de saida "i^2 = resultado".
