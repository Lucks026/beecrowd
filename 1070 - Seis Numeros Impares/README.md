...
Mesma logica nos tres. Verificacao de paridade seguida de loop com incremento de 2. Python usa `x += 1` e `range(6)`, enquanto Java e C++ usam `x++` e `for(int i = 0; i < 6; i++)`.
